...
segm = imread("processed_images_transformed/control_female4/control_female4_segmentation.tif")
mask = imread("processed_images_transformed/control_female4/control_female4_mask.tif")
skel = imread("processed_images_transformed/control_female4/control_female4_skeleton.tif")
...
os.makedirs("outs/geometry_transformed/control_female4")
#Save
segment_metrics.to_csv("outs/geometry_transformed/control_female4/control_female4_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/control_female4/control_female4_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/control_female4/control_female4_distance_to_nearest_vessel.json", "w") as f:
