...
segm = imread("processed_images_transformed/control_female1/control_female1_segmentation.tif")
mask = imread("processed_images_transformed/control_female1/control_female1_mask.tif")
skel = imread("processed_images_transformed/control_female1/control_female1_skeleton.tif")
...
os.makedirs("outs/geometry_transformed/control_female1")
#Save
segment_metrics.to_csv("outs/geometry_transformed/control_female1/control_female1_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/control_female1/control_female1_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/control_female1/control_female1_distance_to_nearest_vessel.json", "w") as f:
