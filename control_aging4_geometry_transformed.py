...
segm = imread("processed_images_transformed/aging4/aging4_segmentation.tif")
mask = imread("processed_images_transformed/aging4/aging4_mask.tif")
skel = imread("processed_images_transformed/aging4/aging4_skeleton.tif")
...
os.makedirs("outs/geometry_transformed/aging4")
#Save
segment_metrics.to_csv("outs/geometry_transformed/aging4/aging4_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/aging4/aging4_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/aging4/aging4_distance_to_nearest_vessel.json", "w") as f:
