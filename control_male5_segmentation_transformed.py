...
#Read in image
img = imread("input_images/control_male5_transformed_cropped.tif")
...
imwrite("processed_images_transformed/control_male5/img_smooth.tif", img_smooth)
...
imwrite("processed_images_transformed/control_male5/control_male5_segmentation_frompipeline.tif", img_fin)
...
img_rescaled = rescale_intensity(img, in_range=(0, 530))
...
#Save mask
imwrite("processed_images_transformed/control_male5/control_male5_mask.tif", mask_noholes)
...
imwrite("processed_images_transformed/control_male5/control_male5_skel_raw.tif", skel)
segm_masked = segm_masked.astype("bool")
imwrite("processed_images_transformed/control_male5/control_male5_segmentation.tif", segm_masked)


#CREATE NEW SKELETON BASED ON UPDATED SEGMENTATION

#Load
segm_fixed = imread("processed_images_transformed/control_male5/control_male5_segmentation.tif")

skel = skeletonize(segm_fixed)
skel = skel.astype("bool")

imwrite("processed_images_transformed/control_male5/control_male5_skeleton.tif", skel)
