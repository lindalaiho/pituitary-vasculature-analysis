...
segm = imread("processed_images_transformed/stress1/stress1_segmentation.tif")
mask = imread("processed_images_transformed/stress1/stress1_mask.tif")
skel = imread("processed_images_transformed/stress1/stress1_skeleton.tif")
...
os.makedirs("outs/geometry_transformed/stress1")
#Save
segment_metrics.to_csv("outs/geometry_transformed/stress1/stress1_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/stress1/stress1_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/stress1/stress1_distance_to_nearest_vessel.json", "w") as f:
