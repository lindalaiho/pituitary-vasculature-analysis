...
#Read in image
img = imread("input_images/control_female3_transformed_cropped.tif")
...
img_adj = adjust_gamma(img, 0.65)
img_adj[img_cp == 1] = img_adj.max()

#Apply smoothing
img_smooth = edge_preserving_smoothing_3d(img_adj, numberOfIterations=10)
imwrite("processed_images_transformed/control_female3/img_smooth.tif", img_smooth)
...
imwrite("processed_images_transformed/control_female3/control_female3_segmentation_frompipeline.tif", img_fin)
...
#Save mask
imwrite("processed_images_transformed/control_female3/control_female3_mask.tif", mask_noholes)
...
imwrite("processed_images_transformed/control_female3/control_female3_skel_raw.tif", skel)
segm_masked = segm_masked.astype("bool")
imwrite("processed_images_transformed/control_female3/control_female3_segmentation.tif", segm_masked)


#CREATE NEW SKELETON BASED ON UPDATED SEGMENTATION

#Load
segm_fixed = imread("processed_images_transformed/control_female3/control_female3_segmentation.tif")

skel = skeletonize(segm_fixed)
skel = skel.astype("bool")

imwrite("processed_images_transformed/control_female3/control_female3_skeleton.tif", skel)
