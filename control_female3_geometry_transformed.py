...
segm = imread("processed_images_transformed/control_female3/control_female3_segmentation.tif")
mask = imread("processed_images_transformed/control_female3/control_female3_mask.tif")
skel = imread("processed_images_transformed/control_female3/control_female3_skeleton.tif")
...
os.makedirs("outs/geometry_transformed/control_female3")
#Save
segment_metrics.to_csv("outs/geometry_transformed/control_female3/control_female3_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/control_female3/control_female3_volume_metrics.csv", index=False)

#Get distance from every non-vessel pixel to nearest vessel
...
with open("outs/geometry_transformed/control_female3/control_female3_distance_to_nearest_vessel.json", "w") as f:
