...
segm = imread("processed_images_transformed/aging3/aging3_segmentation.tif")
mask = imread("processed_images_transformed/aging3/aging3_mask.tif")
skel = imread("processed_images_transformed/aging3/aging3_skeleton.tif")
...
os.makedirs("outs/geometry_transformed/aging3")
#Save
segment_metrics.to_csv("outs/geometry_transformed/aging3/aging3_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/aging3/aging3_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/aging3/aging3_distance_to_nearest_vessel.json", "w") as f:
