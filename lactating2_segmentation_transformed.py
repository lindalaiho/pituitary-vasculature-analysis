...
#Read in image
img = imread("input_images/lactating2_transformed_cropped.tif")
...
imwrite("processed_images_transformed/lactating2/img_smooth.tif", img_smooth)
...
imwrite("processed_images_transformed/lactating2/lactating2_segmentation_frompipeline.tif", img_fin)
...
img_rescaled = rescale_intensity(img, in_range=(0, 500))

#Binarise at appropriate threshold
mask = img_rescaled > 60000
...
#Save mask
imwrite("processed_images_transformed/lactating2/lactating2_mask.tif", mask_noholes)
...
imwrite("processed_images_transformed/lactating2/lactating2_skel_raw.tif", skel)
segm_masked = segm_masked.astype("bool")
imwrite("processed_images_transformed/lactating2/lactating2_segmentation.tif", segm_masked)


#CREATE NEW SKELETON BASED ON UPDATED SEGMENTATION

#Load
segm_fixed = imread("processed_images_transformed/lactating2/lactating2_segmentation.tif")

skel = skeletonize(segm_fixed)
skel = skel.astype("bool")

imwrite("processed_images_transformed/lactating2/lactating2_skeleton.tif", skel)
