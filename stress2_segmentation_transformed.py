...
#Read in image
img = imread("input_images/stress2_transformed_cropped.tif")
...
imwrite("processed_images_transformed/stress2/img_smooth.tif", img_smooth)
...
imwrite("processed_images_transformed/stress2/stress2_segmentation_frompipeline.tif", img_fin)
...
#Save mask
imwrite("processed_images_transformed/stress2/stress2_mask.tif", mask_noholes)
...
imwrite("processed_images_transformed/stress2/stress2_skel_raw.tif", skel)
segm_masked = segm_masked.astype("bool")
imwrite("processed_images_transformed/stress2/stress2_segmentation.tif", segm_masked)


#CREATE NEW SKELETON BASED ON UPDATED SEGMENTATION

#Load
segm_fixed = imread("processed_images_transformed/stress2/stress2_segmentation.tif")

skel = skeletonize(segm_fixed)
skel = skel.astype("bool")

imwrite("processed_images_transformed/stress2/stress2_skeleton.tif", skel)
