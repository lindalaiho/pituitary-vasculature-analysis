...
segm = imread("processed_images_transformed/control_female2/control_female2_segmentation.tif")
mask = imread("processed_images_transformed/control_female2/control_female2_mask.tif")
skel = imread("processed_images_transformed/control_female2/control_female2_skeleton.tif")
...
os.makedirs("outs/geometry_transformed/control_female2")
#Save
segment_metrics.to_csv("outs/geometry_transformed/control_female2/control_female2_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/control_female2/control_female2_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/control_female2/control_female2_distance_to_nearest_vessel.json", "w") as f:
