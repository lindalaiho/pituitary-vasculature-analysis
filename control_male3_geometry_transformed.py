...
segm = imread("processed_images_transformed/control_male3/control_male3_segmentation.tif")
mask = imread("processed_images_transformed/control_male3/control_male3_mask.tif")
skel = imread("processed_images_transformed/control_male3/control_male3_skeleton.tif")
...
os.makedirs("outs/geometry_transformed/control_male3")
#Save
segment_metrics.to_csv("outs/geometry_transformed/control_male3/control_male3_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/control_male3/control_male3_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/control_male3/control_male3_distance_to_nearest_vessel.json", "w") as f:
