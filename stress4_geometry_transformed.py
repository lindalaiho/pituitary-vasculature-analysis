...
segm = imread("processed_images_transformed/stress4/stress4_segmentation.tif")
mask = imread("processed_images_transformed/stress4/stress4_mask.tif")
skel = imread("processed_images_transformed/stress4/stress4_skeleton.tif")
...
os.makedirs("outs/geometry_transformed/stress4")
#Save
segment_metrics.to_csv("outs/geometry_transformed/stress4/stress4_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/stress4/stress4_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/stress4/stress4_distance_to_nearest_vessel.json", "w") as f:
