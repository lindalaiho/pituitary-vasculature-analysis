...
segm = imread("processed_images_transformed/stress2/stress2_segmentation.tif")
mask = imread("processed_images_transformed/stress2/stress2_mask.tif")
skel = imread("processed_images_transformed/stress2/stress2_skeleton.tif")
...
os.makedirs("outs/geometry_transformed/stress2")
#Save
segment_metrics.to_csv("outs/geometry_transformed/stress2/stress2_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/stress2/stress2_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/stress2/stress2_distance_to_nearest_vessel.json", "w") as f:
