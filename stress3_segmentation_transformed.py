...
seg_param=[[1.4, 0.003]]
bincl_param=np.ones((1,5,5))
hole_min_param=1
hole_max_param=60
smallobj_param=200

#Read in image
img = imread("input_images/stress3_transformed_cropped.tif")
...
imwrite("processed_images_transformed/stress3/img_smooth.tif", img_smooth)
...
imwrite("processed_images_transformed/stress3/stress3_segmentation_frompipeline.tif", img_fin)
...
#Save mask
imwrite("processed_images_transformed/stress3/stress3_mask.tif", mask_noholes)
...
imwrite("processed_images_transformed/stress3/stress3_skel_raw.tif", skel)
segm_masked = segm_masked.astype("bool")
imwrite("processed_images_transformed/stress3/stress3_segmentation.tif", segm_masked)


#CREATE NEW SKELETON BASED ON UPDATED SEGMENTATION

#Load
segm_fixed = imread("processed_images_transformed/stress3/stress3_segmentation.tif")

skel = skeletonize(segm_fixed)
skel = skel.astype("bool")

imwrite("processed_images_transformed/stress3/stress3_skeleton.tif", skel)
