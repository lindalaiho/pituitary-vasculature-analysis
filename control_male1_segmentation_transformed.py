...
#Read in image
img = imread("input_images/control_male1_transformed_cropped.tif")
...
imwrite("processed_images_transformed/control_male1/img_smooth.tif", img_smooth)
...
imwrite("processed_images_transformed/control_male1/control_male1_segmentation_frompipeline.tif", img_fin)
...
img_rescaled = rescale_intensity(img, in_range=(34, 349)) 

#Binarise at appropriate threshold
mask = img_rescaled > 39000
...
#Save mask
imwrite("processed_images_transformed/control_male1/control_male1_mask.tif", mask_noholes)
...
imwrite("processed_images_transformed/control_male1/control_male1_skel_raw.tif", skel)
segm_masked = segm_masked.astype("bool")
imwrite("processed_images_transformed/control_male1/control_male1_segmentation.tif", segm_masked)


#CREATE NEW SKELETON BASED ON UPDATED SEGMENTATION

#Load
segm_fixed = imread("processed_images_transformed/control_male1/control_male1_segmentation.tif")

skel = skeletonize(segm_fixed)
skel = skel.astype("bool")

imwrite("processed_images_transformed/control_male1/control_male1_skeleton.tif", skel)
