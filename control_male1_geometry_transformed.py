...
segm = imread("processed_images_transformed/control_male1/control_male1_segmentation.tif")
mask = imread("processed_images_transformed/control_male1/control_male1_mask.tif")
skel = imread("processed_images_transformed/control_male1/control_male1_skeleton.tif")
...
#Save
segment_metrics.to_csv("outs/geometry_transformed/control_male1/control_male1_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/control_male1/control_male1_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/control_male1/control_male1_distance_to_nearest_vessel.json", "w") as f:
