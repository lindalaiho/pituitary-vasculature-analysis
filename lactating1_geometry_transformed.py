...
segm = imread("processed_images_transformed/lactating1/lactating1_segmentation.tif")
mask = imread("processed_images_transformed/lactating1/lactating1_mask.tif")
skel = imread("processed_images_transformed/lactating1/lactating1_skeleton.tif")
...
os.makedirs("outs/geometry_transformed/lactating1")
#Save
segment_metrics.to_csv("outs/geometry_transformed/lactating1/lactating1_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/lactating1/lactating1_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/lactating1/lactating1_distance_to_nearest_vessel.json", "w") as f:
