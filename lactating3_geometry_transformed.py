...
segm = imread("processed_images_transformed/lactating3/lactating3_segmentation.tif")
mask = imread("processed_images_transformed/lactating3/lactating3_mask.tif")
skel = imread("processed_images_transformed/lactating3/lactating3_skeleton.tif")
...
os.makedirs("outs/geometry_transformed/lactating3")
#Save
segment_metrics.to_csv("outs/geometry_transformed/lactating3/lactating3_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/lactating3/lactating3_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/lactating3/lactating3_distance_to_nearest_vessel.json", "w") as f:
