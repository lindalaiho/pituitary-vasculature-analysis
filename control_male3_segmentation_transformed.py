...
#Read in image
img = imread("input_images/control_male3_transformed_cropped.tif")
...
imwrite("processed_images_transformed/control_male3/img_smooth.tif", img_smooth)
...
imwrite("processed_images_transformed/control_male3/control_male3_segmentation_frompipeline.tif", img_fin)
...
img_rescaled = rescale_intensity(img, in_range=(0, 319))

#Binarise at appropriate threshold
mask = img_rescaled > 37000
...
#Save mask
imwrite("processed_images_transformed/control_male3/control_male3_mask.tif", mask_noholes)
...
imwrite("processed_images_transformed/control_male3/control_male3_skel_raw.tif", skel)
segm_masked = segm_masked.astype("bool")
imwrite("processed_images_transformed/control_male3/control_male3_segmentation.tif", segm_masked)


#CREATE NEW SKELETON BASED ON UPDATED SEGMENTATION

#Load
segm_fixed = imread("processed_images_transformed/control_male3/control_male3_segmentation.tif")

skel = skeletonize(segm_fixed)
skel = skel.astype("bool")

imwrite("processed_images_transformed/control_male3/control_male3_skeleton.tif", skel)
