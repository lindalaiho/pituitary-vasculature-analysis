...
segm = imread("processed_images_transformed/control_male5/control_male5_segmentation.tif")
mask = imread("processed_images_transformed/control_male5/control_male5_mask.tif")
skel = imread("processed_images_transformed/control_male5/control_male5_skeleton.tif")
...
os.makedirs("outs/geometry_transformed/control_male5")
#Save
segment_metrics.to_csv("outs/geometry_transformed/control_male5/control_male5_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/control_male5/control_male5_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/control_male5/control_male5_distance_to_nearest_vessel.json", "w") as f:
