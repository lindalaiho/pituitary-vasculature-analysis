...
segm = imread("processed_images_transformed/control_male1/control_male1_pp_segmentation.tif")
mask = imread("processed_images_transformed/control_male1/control_male1_mask_posterior.tif")
skel = imread("processed_images_transformed/control_male1/control_male1_pp_skeleton.tif")
...
#os.makedirs("outs/geometry_transformed/control_male1")
#Save
segment_metrics.to_csv("outs/geometry_transformed/control_male1/control_male1_pp_segment_metrics.csv", index=False)
...
volume_metrics.to_csv("outs/geometry_transformed/control_male1/control_male1_pp_volume_metrics.csv", index=False)
...
with open("outs/geometry_transformed/control_male1/control_male1_pp_distance_to_nearest_vessel.json", "w") as f:
